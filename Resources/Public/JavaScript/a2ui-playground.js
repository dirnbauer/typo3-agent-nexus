...
ready(() => {
  ...
  function setProvenance(provenance) {
    ...
    provEl.className = 'a2ui-status ' + (isLlm ? 'a2ui-status--live' : 'a2ui-status--offline');
    provEl.title = isLlm
  ...
  function setBusy(busy) {
    ...
    if (liveEl && busy) {
      liveEl.innerHTML = '<div class="text-body-secondary d-flex align-items-center gap-2 p-3">'
        + '<span class="spinner-border spinner-border-sm"></span> The agent is composing your interface…</div>';
    }
  }
